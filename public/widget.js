(function () {
  ...
  var WEBHOOK_URL = 'https://n8n-production-5c06.up.railway.app/webhook/realx-ai'; // REPLACE with prod URL
  var API_KEY     = 'rx-chat-sk-2026-M9aG'; // REPLACE with VITE_API_KEY_PROD
  var CHANNEL     = 'WEBSITE';
